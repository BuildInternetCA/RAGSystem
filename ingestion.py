...
class IngestionEngine:
    ...
    def GetDatabase(self):
        ...
        documents = self.LoadDocuments(directory_path)
        # STEP 2: Split Documents
        print("Splitting documents...")
        split_documents = self.SplitDocuments(documents)
        # STEP 3: Create Vector Store
        print("Creating vector store...")
        vector_store = self.CreateVectorStore(split_documents, persist_directory)
